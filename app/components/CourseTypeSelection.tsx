...
export function CourseTypeSelection({ onSelect }) {
  return (
    <div className="space-y-6">
      <h3 className="text-xl font-semibold mb-4">Choose Your Course Type</h3>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        >
          <CardContent className="p-6 text-center">
            ...
            <h4 className="text-lg font-semibold mb-2">Traditional Course</h4>
        ...
        >
          <CardContent className="p-6 text-center">
            ...
            <h4 className="text-lg font-semibold mb-2">College Course</h4>
